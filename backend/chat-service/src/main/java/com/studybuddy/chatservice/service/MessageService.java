...
public class MessageService {
    ...
    public Long getChatIdByStudyGroupId(Long studyGroupId) {
        return chatRepository.findChatIdByStudyGroupId(studyGroupId)
                .orElseThrow(() -> new RuntimeException("No chat found for the given study group ID."));
    }
}
